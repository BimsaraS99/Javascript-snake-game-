...
const controlKeys = document.querySelectorAll('.game-buttons i');
...
controlKeys.forEach(key => {
    key.addEventListener("click", () => changeDirection({key: key.dataset.val}));
});
...
//you can download the code from the link i have given  i the description
//we can control the game using arrow keys of the keyboard. 
//also we can use button that given in the web interface